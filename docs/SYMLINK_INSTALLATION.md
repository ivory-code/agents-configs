...
## Relationship To CodeWard

`agents-configs` defines how agents should behave inside a repo. CodeWard can then inspect that repo and produce review, validation, and E2E planning evidence.

Together:

- `agents-configs`: reusable agent operating layer
- CodeWard: PR verification and QA planning layer
